...
from accnt_api.models import Transaction
from sqlalchemy import create_engine
from sqlalchemy.ext.declarative import declarative_base
from sqlalchemy.orm import sessionmaker

app = Flask(__name__, template_folder='accnt_api/templates')
...
def get_transactions():
  ...
  try:
    ...
    db_string = 'postgresql://postgres:Mia$wet16@localhost/accnt_api_db'
    ...
    for tran in transactions:
      ...
      db_session.add(t)
      db_session.commit()
      print(str(tran['transaction_id']) + "Transaction added to the database")
